...
- The adjacent nodes at any depth are calculated for you based on the provided list of neighboring nodes (depth of 1)
...
- Note that the order the nodes are added is the same order they are expected for pattern completion
